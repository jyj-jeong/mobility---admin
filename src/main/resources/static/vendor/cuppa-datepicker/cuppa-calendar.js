(function(window){
	...
	var cal_days_labels = ['일', '월', '화', '수', '목', '금', '토'];
	var cal_full_days_lables = ["일요일","월요일","화요일","수요일","목요일","금요일","토요일"];

	// these are human-readable month name labels, in order
	var cal_months_labels = ['1월', '2월', '3월', '4월',
		'5월', '6월', '7월', '8월', '9월',
		'10월', '11월', '12월'];
	var cal_months_labels_short = ['1월', '2월', '3월', '4월',
		'5월', '6월', '7월', '8월', '9월',
		'10월', '11월', '12월'];
