 ...
 * @since 2019. 11. 20
 */
public class CarssumMap extends LinkedHashMap<String, Object> {
     ...
     * @param isDate
     */
    public CarssumMap(boolean isDate) {
        super();
     ...
     * @param map
     */
    public CarssumMap(Map<String, Object> map) {
        this(map, true);
    }
     ...
     * @param isDate
     */
    public CarssumMap(Map<String, Object> map, boolean isDate) {
        super();
    ...
    public static CarssumMap jsonToCarssumMap(JSONObject json) throws JSONException {
        CarssumMap retMap = new CarssumMap();
    ...
    public static CarssumMap toMap(JSONObject object) throws JSONException {
        CarssumMap map = new CarssumMap();
