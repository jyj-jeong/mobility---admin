...
public class CsdealCarDto extends CommonResponseDto {
	...
	public String getDriveCareer_limit() {
		return driveCareer_limit;
	}
	public void setDriveCareer_limit(String driveCareer_limit) {
		this.driveCareer_limit = driveCareer_limit;
	}
	...
	public String getOptionCodeValue() {
		return optionCodeValue;
	}
	public void setOptionCodeValue(String optionCodeValue) {
		this.optionCodeValue = optionCodeValue;
	}
