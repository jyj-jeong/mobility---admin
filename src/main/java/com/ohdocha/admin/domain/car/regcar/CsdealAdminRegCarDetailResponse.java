...
public class CsdealAdminRegCarDetailResponse {
	...
	private String insuranceFee2		; //보험료2 -->
	private String insuranceFee3		; //보험료3 -->
	private String insuranceFee4		; //보험료4 -->
	private String mmRentAmt			; //장기 월 대여요금 -->
	private String mmLastRentAmt		; //장기 마지막월 대여요금 -->
	private String commissionPer		; //회원사 수수료 -->
	private String calcPeriodDt			; //대여 기간 [oo년oo개월oo일oo시간oo분]
	private String periodMm				; //대여 총 개월수
	...
	public String getMmRentAmt() {
		return mmRentAmt;
	}
	public void setMmRentAmt(String mmRentAmt) {
		this.mmRentAmt = mmRentAmt;
	}
	public String getMmLastRentAmt() {
		return mmLastRentAmt;
	}
	public void setMmLastRentAmt(String mmLastRentAmt) {
		this.mmLastRentAmt = mmLastRentAmt;
	}
	...
	public String getCalcPeriodDt() {
		return calcPeriodDt;
	}
	public void setCalcPeriodDt(String calcPeriodDt) {
		this.calcPeriodDt = calcPeriodDt;
	}
