...
@Data
@Alias("rentCompanyInfoRequest")						   	
public class CsdealAdminRentCompanyInfoRequest  extends CommonRequestDto {
	//CDT_RETNCOMPANYINFO
	...
	private String minimumMi                                  ; // 최소시간(분)
	...
	public String getMinimumMi() {
		return minimumMi;
	}
	public void setMinimumMi(String minimumMi) {
		this.minimumMi = minimumMi;
	}
